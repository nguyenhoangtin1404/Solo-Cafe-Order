...
`VALIDATION_ERROR` | `ORDER_NOT_FOUND` | `PRODUCT_NOT_FOUND` | `CATEGORY_NOT_FOUND` | `OPTION_NOT_FOUND` | `VALUE_NOT_FOUND` | `PRODUCT_UNAVAILABLE` | `INVALID_STATUS_TRANSITION` | `CAFE_CLOSED` | `UNAUTHORIZED` | `FORBIDDEN` | `RATE_LIMITED` | `INTERNAL_ERROR`
